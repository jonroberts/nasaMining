Generating project similiarty scores is a two step process, and there are two scripts toat must be run:

keyword_similiary.py:
	...
	More info is available at https://wordnet.princeton.edu/
	...
	enough time to test them all. See section 5 on http://www.nltk.org/howto/wordnet.html for details.
