...
if __name__ == '__main__':
    ...
    print 'Bigrams'
    desc_bigrams = Phrases(title, threshold=thresh)
    bigrams = desc_bigrams[title]
    ...
    with open('data/nasa_title_ngram_np.json', 'w') as f:
        json.dump(data, f)